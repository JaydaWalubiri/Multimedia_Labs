...
\title{\textbf{2D Graphics and Images}}
\begin{document}
...
The experiment showed clear differences between raster and vector graphics. The SVG image maintained smooth edges and sharp text after enlargement because it stores geometric drawing instructions instead of pixels.
...
These observations explain why image compression is important for efficient storage and web delivery.
...
Different image formats use different compression techniques which affect file size and image quality. JPEG is a lossy compression format that reduces file size by removing visually less important information, making it suitable for photographs. PNG is a lossless format that preserves all image data and is commonly used for screenshots, logos and diagram.
